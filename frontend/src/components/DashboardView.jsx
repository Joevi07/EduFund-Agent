...
import ConfidenceMeterWidget from "./ConfidenceMeterWidget";
import DocumentCollisionWidget from "./DocumentCollisionWidget";
...
export default function DashboardView({ profile, plan, currency, onNavigate, onScenarioResult }) {
  ...
  const logs = [
    ...
    { type: "Planner", text: "📊 Funding Confidence Meter computed score: 88% High Confidence" },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      ...
      {/* Top Row: 4 Vibrant Solid KPI Cards */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.25rem" }}>
        ...
        {/* Card 2: Coral Red (Remaining Gap) */}
      ...
      {/* 🌟 NEW FEATURE SECTION: Funding Confidence & Document Reuse Audit */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "1.25rem" }}>
        <div className="bento-box">
          <ConfidenceMeterWidget profile={profile} />
        </div>
        <div className="bento-box">
          <DocumentCollisionWidget profile={profile} />
        </div>
      </div>
